...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <livewire:scroll-top />
        <!-- HOME -->
        <main id="home" class="flex flex-col w-full min-h-screen " style="background-image:url('../images/bgezra.png'); background-size: cover">
            <!-- NAVIGATION BAR -->
            <livewire:navbar />
            <!-- HERO SECTION -->
            <div class="flex items-center justify-center lg:justify-start min-h-[89vh] w-full md:min-h-[90vh] lg:px-56 ">
                <!-- CONTENT -->
                <div class="flex flex-col  items-start justify-center w-[100%] md:w-[60%] -mb-32 lg:m-0 lg:w-[50%] gap-1 p-10 bg-[#091010] text-white bg-opacity-70">
                    <!-- NAME -->
                    <div class="text-2xl font-semibold text-left lg:text-5xl font-header">EZRA</div>
                    <!-- ROLE -->
                    <div class="text-xl font-medium text-left lg:text-2xl font-header">Cleric</div>
                    <!-- DESCRIPTION -->
                    <div class="flex flex-col gap-1 py-2 text-sm font-semibold text-justify font-body">
                        <div>
                            Ezra was a former necromancer who has since used her abilities to aid the people of Akromos' realm. She ceased practicing necromancy after a deity spared her from impending doom and ordered her to utilize her abilities solely for good. 
                        </div>
                    </div>
                </div>
            </div>
