            ...
            <form class="flex flex-col w-full p-6 h-fit bg-slate-500">
                <div class="flex flex-col items-start text-[28px] ">
                    <div class="flex flex-row gap-3 p-3">
                        ...
                        <input maxlength="30" name="name" type="text" placeholder="Name*" required/>
                    </div>
                    <div class="flex flex-row gap-3 p-3">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <div class="flex flex-row gap-3 p-3">
                        ...
                        <input minlength={6} maxlength="16" name="password" type="password" placeholder="Password*" required/>
                    </div>
                    <div class="flex flex-row gap-3 p-3">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clip-rule="evenodd"></path>
                        </svg>
                        <input minlength={6} maxlength="16" name="confirmPassword" type="password" placeholder="Confirm Password*" required/>
                    </div>
                </div>
                ...
                <div class="flex text-[20px] pt-3 justify-center">
                    <span>Already have an account?</span>
                    <a href="login" class="gap-2 text-red-500 font"> Login here. </a>
                </div>
            </form>
            </div>
        </div>
